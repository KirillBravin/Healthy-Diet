...
function forms() {
  ...
  const postData = async (url, data) => {
    // async говорит что у нас асинхронный код и нужно дождаться его выполнения
    const res = await fetch(url, {
      // await ждёт пока выполнится код и будет помещён в переменную. Async/await работают в паре
      method: "POST",
      headers: {
